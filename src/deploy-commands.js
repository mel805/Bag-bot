...
const commands = [
  ...
  // Actions additionnelles (SFW / RP)
  new SlashCommandBuilder().setName('chatouiller').setDescription('Chatouiller pour gagner du charme').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).addStringOption(o=>o.setName('zone').setDescription('Zone (optionnel)').setRequired(false)).toJSON(),
  new SlashCommandBuilder().setName('reanimer').setDescription('Réanimer pour aider un membre').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).toJSON(),
  new SlashCommandBuilder().setName('reconforter').setDescription('Réconforter pour gagner du charme').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).toJSON(),
  new SlashCommandBuilder().setName('caresser').setDescription('Caresser (RP)').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).addStringOption(o=>o.setName('zone').setDescription('Zone (optionnel)').setRequired(false)).toJSON(),
  new SlashCommandBuilder().setName('tirercheveux').setDescription('Tirer les cheveux (RP)').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).toJSON(),
  new SlashCommandBuilder().setName('tromper').setDescription('Mettre en scène une tromperie (RP) 😈').addUserOption(o=>o.setName('cible').setDescription('Membre (requis)').setRequired(true)).toJSON(),
