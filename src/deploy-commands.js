...
const commands = [
  ...
  new SlashCommandBuilder().setName('caresser').setDescription('Caresser (RP)').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).toJSON(),
  ...
  new SlashCommandBuilder().setName('tromper').setDescription('Mettre en scène une tromperie (RP) 😈').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).toJSON(),
