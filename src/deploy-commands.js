...
const commands = [
  ...
  new SlashCommandBuilder().setName('orgie').setDescription('Orgie consentie (NSFW, 3-7 participants) 😈').addUserOption(o=>o.setName('cible').setDescription('Membre (optionnel)').setRequired(false)).toJSON(),
