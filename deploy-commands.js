...
const commands = [
  ...
  // Commandes avec préfixe action_
  new SlashCommandBuilder().setName('action_embrasser').setDescription('Embrasser avec passion').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_flirter').setDescription('Flirter pour séduire').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_seduire').setDescription('Séduire avec charme').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_caresser').setDescription('Caresser (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).addStringOption(o=>o.setName('zone').setDescription('Zone à caresser (optionnel)').setRequired(false).addChoices({name:'Sein',value:'sein'},{name:'Fesses',value:'fesses'},{name:'Corps',value:'corps'},{name:'Jambes',value:'jambes'},{name:'Bite',value:'bite'},{name:'Pied',value:'pied'},{name:'Nuque',value:'nuque'},{name:'Épaule',value:'épaule'})).toJSON(),
  new SlashCommandBuilder().setName('action_lécher').setDescription('Lécher (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).addStringOption(o=>o.setName('zone').setDescription('Zone à lécher (optionnel)').setRequired(false).addChoices({name:'Seins',value:'seins'},{name:'Chatte',value:'chatte'},{name:'Cul',value:'cul'},{name:'Oreille',value:'oreille'},{name:'Ventre',value:'ventre'},{name:'Bite',value:'bite'})).toJSON(),
  new SlashCommandBuilder().setName('action_sucer').setDescription('Sucer (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).addStringOption(o=>o.setName('zone').setDescription('Zone à sucer (optionnel)').setRequired(false).addChoices({name:'Bite',value:'bite'},{name:'Téton',value:'téton'},{name:'Oreille',value:'oreille'})).toJSON(),
  new SlashCommandBuilder().setName('action_mordre').setDescription('Mordiller (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).addStringOption(o=>o.setName('zone').setDescription('Zone à mordiller (optionnel)').setRequired(false).addChoices({name:'Cou',value:'cou'},{name:'Lèvres',value:'lèvres'},{name:'Épaule',value:'épaule'},{name:'Lobe',value:'lobe'})).toJSON(),
  new SlashCommandBuilder().setName('action_branler').setDescription('Branler (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_doigter').setDescription('Doigter (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).addStringOption(o=>o.setName('zone').setDescription('Zone à doigter (optionnel)').setRequired(false).addChoices({name:'Chatte',value:'chatte'},{name:'Cul',value:'cul'})).toJSON(),
  new SlashCommandBuilder().setName('action_fuck').setDescription('Fuck (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).addStringOption(o=>o.setName('zone').setDescription('Zone (optionnel)').setRequired(false).addChoices({name:'Chatte',value:'chatte'},{name:'Bite',value:'bite'})).toJSON(),
  new SlashCommandBuilder().setName('action_sodo').setDescription('Sodomie (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_orgasme').setDescription('Donner un orgasme (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).addStringOption(o=>o.setName('zone').setDescription('Zone (optionnel)').setRequired(false).addChoices({name:'Chatte',value:'chatte'},{name:'Bite',value:'bite'},{name:'Corps',value:'corps'})).toJSON(),
  new SlashCommandBuilder().setName('action_hairpull').setDescription('Tirer les cheveux (NSFW)').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_shower').setDescription('Douche sensuelle').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_bed').setDescription('Invitation au lit').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_collar').setDescription('Poser un collier').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_leash').setDescription('Tenir en laisse').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_kneel').setDescription('Mettre à genoux').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_order').setDescription('Donner un ordre').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
  new SlashCommandBuilder().setName('action_pillowfight').setDescription('Bataille d\'oreillers').addUserOption(o=>o.setName('cible').setDescription('Membre').setRequired(true)).toJSON(),
