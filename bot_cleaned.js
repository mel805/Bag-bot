...
const eroticMsgBank = {
  ...
  caress: {
    success: [
      'Tes mains caressent {cible} avec douceur électrique.',
      'Tu caresses {cible}, les frissons apparaissent.',
      'Des caresses lentes font monter le désir.',
      'Tes doigts explorent avec tendresse.',
      'Caresses sensuelles, {cible} gémit.'
    ],
    fail: [
      'Tu tentes de caresser {cible}, mais il/elle préfère attendre.',
      'Caresse refusée, ce n\'est pas le bon moment.',
      'Tes gestes sont trop brusques, {cible} grimace.'
    ]
  },
  massage: {
    success: [
      'Tu masses {cible} avec expertise.',
      'Massage sensuel, détente totale.',
      'Tes mains expertes soulagent {cible}.',
      'Massage parfait, {cible} fond de plaisir.',
      'Détente et plaisir partagés.'
    ],
    fail: [
      'Massage refusé par {cible}.',
      'Tes gestes sont maladroits.',
      'Pas d\'humeur pour un massage.'
    ]
  },
  pillowfight: {
    success: [
      'Bataille d\'oreillers torride avec {cible}.',
      'Plumes volent, rires et baisers.',
      'Combat qui dégénère en étreinte.',
      'Oreillers éclatés, passion déchaînée.',
      'Jeu qui devient sensuel.'
    ],
    fail: [
      'Bataille refusée par {cible}.',
      'Oreillers introuvables.',
      'Pas d\'humeur pour jouer.',
      'Coup mal placé, plainte.'
    ]
  },
  lick: {
    success: [
      'Tu lèches {cible} avec gourmandise.',
      'Coups de langue sensuels.',
      'Tu explores avec ta langue.',
      'Léchage passionné.',
      'Saveur délicieuse.'
    ],
    fail: [
      ...
      'Tu es repoussé gentiment.'
    ]
  },
  suck: {
    success: [
      'Tu suces {cible} avec passion.',
      'Aspiration sensuelle.',
      'Succion parfaite.',
      'Plaisir intense.',
      'Technique maîtrisée.'
    ],
  ...
  nibble: {
    success: [
      ...
      'Petites morsures taquines.',
      'Mordillements sensuels.',
      'Dents qui effleurent.',
      'Jeu de morsures.'
    ],
    fail: [
      'Morsure refusée.',
